...
class EmbeddingCacheBase {
 public:
  ...
  virtual void lookup(size_t table_id, float* d_vectors, const void* h_keys,
                      const void* h_keys_full_cache, size_t num_keys, size_t num_keys_full_cache,
                      float hit_rate_threshold, cudaStream_t stream) = 0;
  ...
  virtual void insert(size_t table_id, EmbeddingCacheWorkspace& workspace_handler,
                      cudaStream_t stream) = 0;
  virtual void insert(size_t table_id, EmbeddingCacheWorkspace& workspace_handler,
                      cudaStream_t stream, bool full_cache_insertion) = 0;
